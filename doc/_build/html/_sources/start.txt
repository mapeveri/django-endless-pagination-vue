...
The Git repository can be cloned with this command::
    ...
    git clone https://github.com/mapeveri/django-endless-pagination-vue.git

The ``endless_pagination`` package, included in the distribution, should be
placed on the ``PYTHONPATH``.

Via pip ``pip install django-endless-pagination-vue``.
...
Pagination Vue features, have a look at :doc:`twitter_pagination` or
:doc:`digg_pagination`.
